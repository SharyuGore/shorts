...
public class HumanReadableDate {
	...
	static Logger logger = Logger.getLogger(HumanReadableDate.class.getName());
	...
	static String validateThenConvertBasedOnInput(String[] args) {
		...
		return StringUtils.capitalize(timeYouLike);
	}

	private static boolean userInputisValid(String[] args) {		
	...
	private static String convertTimeToHumanReadableFormat(String argument) {
